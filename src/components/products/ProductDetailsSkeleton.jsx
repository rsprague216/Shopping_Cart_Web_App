        ...
        <div className="space-y-6 bg-blue-100 dark:bg-slate-800 rounded-lg p-6">
            <div className="animate-pulse space-y-6">
                ...
                <div className="flex flex-col md:flex-row">
                    {/* Image placeholder */}
                    <div className="w-full h-48 bg-blue-300 dark:bg-slate-700 rounded-t-xl md:w-48 md:shrink-0 md:rounded-t-none md:rounded-l-xl"></div>

                    {/* Info area */}
                    <div className="flex flex-col flex-1 gap-5 p-4 bg-white dark:bg-slate-900 rounded-b-xl md:rounded-b-none md:rounded-r-xl">
                        {/* Title — two lines to approximate a typical long title */}
                        <div className="space-y-2">
                            <div className="h-8 bg-blue-300 dark:bg-slate-700 rounded w-full"></div>
                            <div className="h-8 bg-blue-300 dark:bg-slate-700 rounded w-4/5"></div>
                        </div>

                        {/* Category badge + price */}
                        <div className="flex gap-5 items-center">
                            <div className="h-6 bg-blue-300 dark:bg-slate-700 rounded-full w-24"></div>
                            <div className="h-6 bg-blue-300 dark:bg-slate-700 rounded w-16"></div>
                        </div>

                        {/* Star rating */}
                        <div className="h-4 bg-blue-300 dark:bg-slate-700 rounded w-36"></div>
                    </div>
                </div>
                ...
                <div className="w-full md:w-48 md:ml-auto">
                    <div className="h-10 bg-blue-300 dark:bg-slate-700 rounded-lg"></div>
                </div>
            </div>
        </div>
    );
